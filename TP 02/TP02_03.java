...
public class pesquisaSequencial {
    ...
    public static void main(String[] args) {
        ...
        Pokemon[] listaPoke = new Pokemon[801];
        ...
        listaPoke[a] = pokemons[num - 1];
        a++;
        }
        }

        long inicio = System.nanoTime();
        while(!strcmp2(nomes, "FIM")){

            resp = false;
            nomes = sc.nextLine();
    
            if(!strcmp2(nomes, "FIM")){

            for(int i = 0; i < a; i++){
                String inicial = listaPoke[i].getNome();
                if(strcmp2(inicial, nomes) == true){
        ...
        try (PrintStream log = new PrintStream("842843_sequencial.txt")) {
